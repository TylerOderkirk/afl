...
/* Some notes about making the instrumentation perform better:
   ...
   - Interestingly, this code isn't a lot faster if we store a variable
     ...
     from within trampoline_fmt. It does speed up non-instrumented execution
     quite a bit, though, since that path just becomes push-call-ret-pop.
   ...
   - popf is *awfully* slow, which is why we're doing the lahf /
